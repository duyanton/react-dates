...
var SingleDatePicker = function (_React$Component) {
  ...
  function SingleDatePicker(props) {
    ...
    _this.state = {
      ...
      time: null,
      dateTime: props.dateTime && (0, _moment2['default'])(props.dateTime * 1000),
      timeItemElementId: null
    };

    if (props.dateTime) {
      var time = (0, _moment2['default'])(props.dateTime * 1000);
  ...
  _createClass(SingleDatePicker, [{
    ...
    value: function () {
      function onDateChange(date) {
        var dateTime = (0, _moment2['default'])(String(date.format('DD/MM/YYYY')) + ' ' + String(this.state.time), 'DD/MM/YYYY hh:mm A');
        this.props.onDateTimeChange(dateTime.unix());
        this.setState({ dateTime: dateTime, date: date });
      }
    ...
    value: function () {
      function onTimeChange(time) {
        var dateTime = (0, _moment2['default'])(String(this.state.date.format('DD/MM/YYYY')) + ' ' + String(time), 'DD/MM/YYYY hh:mm A');
        this.props.onDateTimeChange(dateTime.unix());
        this.setState({ dateTime: dateTime, time: time });
      }
    ...
    value: function () {
      function getDateTimeString() {
        ...
        var value = this.state.dateTime;
        var dayName = value.format('dddd');
        dayName = dayName.substr(0, 1).toUpperCase() + dayName.substr(1);
        var date = value.format('D');
        var month = value.format('M');
        var year = value.format('YYYY');
        var hours = value.format('HH:mm');
        var displayString = String(dayName) + ', ' + String(date) + ' th\xE1ng ' + String(month) + ', ' + String(year) + ' v\xE0o l\xFAc ' + String(hours);
    ...
    value: function () {
      function renderDayPicker() {
        ...
        if (isMobile) {
          ...
          }), _react2['default'].createElement('div', { style: { width: '100%', backgroundColor: '#f9f9f9', padding: '0', zIndex: 2 } }, _react2['default'].createElement('div', { style: { height: '100px', margin: '15px 0', overflowY: 'scroll', overflowX: 'hidden' } }, _react2['default'].createElement('ul', { style: { margin: '0', height: '100%', padding: '0 15px' } },
          ...
          TIMES.map(function (time) {
            ...
            return _react2['default'].createElement('li', {
              ...
              onClick: function () {
                function onClick() {
                  return _this2.onTimeChange(time);
                }
          ...
          )))), _react2['default'].createElement('div', { className: 'SingleDatePickerFooter' }, _react2['default'].createElement('div', null, this.state.date && this.state.time && String(this.state.date.format('DD/MM/YYYY')) + ', ' + String(this.state.time)), _react2['default'].createElement('div', null, _react2['default'].createElement('button', {
        ...
        return _react2['default'].createElement('div', { // eslint-disable-line jsx-a11y/no-static-element-interactions
          ...
          isDayHighlighted: isDayHighlighted,
          firstDayOfWeek: firstDayOfWeek
        }), _react2['default'].createElement('div', { style: { minWidth: '25%', backgroundColor: '#f9f9f9', padding: '15px 0 15px 0', zIndex: 2 } }, _react2['default'].createElement('div', { style: { height: '90%', margin: '15px 0', overflowY: 'scroll', overflowX: 'hidden' } }, _react2['default'].createElement('ul', { style: { margin: '0', height: '100%', padding: '0 15px' } },
        ...
        /* eslint-enable */
          ...
          className: 'CalendarDay__selectButton',
          onClick: this.onDateTimeSelect
        }, "Ch\u1ECDn"))), withFullScreenPortal && _react2['default'].createElement('button', {
    ...
    value: function () {
      function render() {
        ...
        var displayValue = this.getDateTimeString();
