  ...
  _createClass(SingleDatePicker, [{
    ...
    value: function () {
      function renderDayPicker() {
        ...
        }), _react2['default'].createElement('div', { style: { width: '127px', backgroundColor: '#f9f9f9', padding: '15px 0 15px 0' } }, _react2['default'].createElement('div', { style: { height: '90%', margin: '15px 0', overflow: 'scroll' } }, _react2['default'].createElement('ul', { style: { height: '100%', padding: '0 20px' } },
