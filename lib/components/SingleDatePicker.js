    ...
    value: function () {
      function renderDayPicker() {
        ...
        if (isMobile) {
          ...
          }), _react2['default'].createElement('div', { style: { width: '100%', backgroundColor: '#f9f9f9', padding: '0' } }, _react2['default'].createElement('div', { style: { height: '100px', margin: '15px 0', overflow: 'scroll' } }, _react2['default'].createElement('ul', { style: { margin: '0', height: '100%', padding: '0 15px' } },
        ...
        return _react2['default'].createElement('div', { // eslint-disable-line jsx-a11y/no-static-element-interactions
          ...
          isDayHighlighted: isDayHighlighted,
          firstDayOfWeek: firstDayOfWeek
        }), _react2['default'].createElement('div', { style: { width: '25%', backgroundColor: '#f9f9f9', padding: '15px 0 15px 0' } }, _react2['default'].createElement('div', { style: { height: '90%', margin: '15px 0', overflow: 'scroll' } }, _react2['default'].createElement('ul', { style: { margin: '0', height: '100%', padding: '0 15px' } },
