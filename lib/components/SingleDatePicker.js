    ...
    value: function () {
      function renderDayPicker() {
        ...
        if (isMobile) {
          ...
          }), _react2['default'].createElement('div', { style: { width: '100%', backgroundColor: '#f9f9f9', padding: '0', zIndex: 2 } }, _react2['default'].createElement('div', { style: { height: '60px', margin: '15px 0', overflowY: 'scroll', overflowX: 'hidden' } }, _react2['default'].createElement('ul', { style: { margin: '0', height: '100%', padding: '0 15px' } },
